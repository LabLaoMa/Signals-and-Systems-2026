...
![](imglink/159772dd-711e-4cf6-b135-d8485880c667-11.png){width=45%}
![](imglink/159772dd-711e-4cf6-b135-d8485880c667-11_2.png){width=45%}
...
$$
x_{(m)}[n]= \begin{cases}x[n / m], & \text { if } n \text { 是 } m  \text {的倍数} \\ 0, & \text { 其他 }\end{cases}
$$
...
本表列出了离散时间常用信号的 **傅里叶变换 (DTFT)** 以及相关的 **傅里叶级数系数 ($a_k$)**。
